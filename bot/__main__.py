...
'''
        ...
        text = f"⛔ Sorry, Access Denied 🚫\n💸 Cost: ₹2 per day\n 🛒 To Buy Contact: @FlashSpeedster"
        if PICS:
...
help_string = '''
<b><a href='https://t.me/Ace_ML'>VPS Bot</a></b> - The Ultimate Virtual Private Server Bot to Upload Your Files to Google Drive & Telegram
